...
sibship_factors <- sibship_factors %>%
  left_join(
    combined %>%
      select(subject_id, `Words Produced`, `Words Understood`, `Total Produced`),
    by = c("Subject_ID" = "subject_id")
  )
